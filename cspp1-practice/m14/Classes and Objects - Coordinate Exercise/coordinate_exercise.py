...
class Coordinate(object):
    ...
    def __eq__(self,other):
        if self.getX()==other.getX() and other.getY()==self.getY():
            return True
        return False  
...
def main():
    ...
    #print(Coordinate(data[0],data[1]).__repr__(Coordinate(data[2],data[3])))
    #x=Coordinate(data[0],data[1]).__repr__()
    #y=Coordinate(data[4],data[5]).__repr__()
    #print(x==y)
